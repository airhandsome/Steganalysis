...
if os.path.exists("/home/test_data/temp.model"):
    os.system("rm " + "/home/test_data/temp.model")


os.system("mkdir "+local_temp_dir)
os.system("mkdir "+local_result_dir)
copy_local=" fs -get "+"/user/hadoop/temp.model"+" /home/test_data/temp.model"
hadoopcmd = hadoop_cmd + copy_local
os.system(hadoopcmd)
...
for line in sys.stdin:
    ...
    model_path = "/home/test_data/temp.model"
