...
def hadoop_51(local_img_path, local_txt_path,local_output,taskid):
    ...
    file_path = "/home/test_data/5_mapper_reducer/51_predict/mapper_predict.py,/home/test_data/5_mapper_reducer/51_predict/reducer_predict.py" 
    ...
    run_hadoopcmd("jar ${HADOOP_HOME}/share/hadoop/tools/lib/hadoop-streaming-2.7.4.jar "\
                +"-D mapred.map.tasks=4 -D mapred.job.priority=HIGH  -D mapreduce.map.memory.mb=8192"\
